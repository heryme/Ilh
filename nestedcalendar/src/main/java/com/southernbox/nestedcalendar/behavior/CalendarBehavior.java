...
public class CalendarBehavior extends ViewOffsetBehavior<MaterialCalendarView> {
    ...
    public void setMonthMode(MaterialCalendarView calendarView) {
//        calendarView.setTileHeight(24);
    ...
    public void setWeekMode(MaterialCalendarView calendarView) {
//        calendarView.setTileHeight(-10);
        if (calendarMode != CalendarMode.MONTHS) {
            return;
        }
        calendarMode = null;
