...
import com.activityhub.utils.extension.dismissDialog
import com.activityhub.utils.extension.getProgressDialog
...
class ApiRequest<T>(private val activity: Activity,
                    ...
                    private val apiResponseInterface: ApiResponseInterface) : Callback<T>, Parcelable {
